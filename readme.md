...
- להוסיף פקודה כמו / eventcash {@user} {time} , שמה שהיא עושה זה שברגע שסגן מנהל שרת או מנהל שרת עושה אותה, יש 30 שניות- 120 שניות ששקים של 500 קרדיטים נופלים מהבן אדם לזמן שהוא קבע.בנוסף השחקן מקבל ספיד בוסט שחל 125x
